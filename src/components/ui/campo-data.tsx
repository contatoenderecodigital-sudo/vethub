        ...
        <Popover.Root open={aberto} onOpenChange={setAberto}>
          <Popover.Trigger asChild>
            <button
              ...
              className="flex size-6 shrink-0 cursor-pointer items-center justify-center rounded text-white/70 hover:bg-white/20 hover:text-white focus-visible:outline-2 focus-visible:outline-white/40"
            >
