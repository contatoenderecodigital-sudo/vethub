  ...
  return (
    <div>
      <PageHeader
        ...
        acao={<ButtonLink href="/tutores/novo">+ Novo tutor</ButtonLink>}
      />
      ...
      {!tutores || tutores.length === 0 ? (
        <EmptyState
          ...
          acao={
            !q && <ButtonLink href="/tutores/novo">Cadastrar tutor</ButtonLink>
          }
        />
      ) : (
          ...
          <ul className="divide-y divide-edge">
            {tutores.map((t) => (
              <li key={t.id}>
                <Link
                  href={`/tutores/${t.id}`}
                  className="flex items-center justify-between gap-3 px-4 py-3 transition-colors hover:bg-brand-mint/10"
                >
